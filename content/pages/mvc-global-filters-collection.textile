...
MVC has one static @GlobalFilters@ class which instantiates the @GlobalFilterCollection@ class and exposes through @Filters@ property which in turn is added in to the @FilterProviderCollection@ inside the static constructor of @FilterProviders@.
